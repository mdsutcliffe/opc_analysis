...
write.table(x = sig_matrix,file = "./temp/signature_matrix_100.txt",append = F,quote = F,sep = "\t",row.names = F,col.names = T)
...
write.table(x = sig_matrix_pericyte,file = "./temp/signature_matrix_pericyte_100.txt",append = F,quote = F,sep = "\t",row.names = F,col.names = T)

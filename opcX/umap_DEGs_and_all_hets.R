...
# List all genes of interest (bulk DEGs + 10c hets)
DEGs_and_hets <- Reduce(union,list(opc12_rheg,opc12_uniqueF,opc12_uniqueM,
...
umap_all_scale <- umap_all_scale[DEGs_and_hets,]
...
pdf(file = "./plots/UMAP_DEGs_and_all_hets.pdf",width = 2.25,height = 2.25,pointsize = 7,useDingbats = F)
...
# Plot bulk150
pdf(file = "./plots/UMAP_DEGs_and_all_hets_bulk150.pdf",width = 1.5625,height = 1.5625,pointsize = 7,useDingbats = F)
...
# Plot bulk12
pdf(file = "./plots/UMAP_DEGs_and_all_hets_bulk12.pdf",width = 1.5625,height = 1.5625,pointsize = 7,useDingbats = F)
par(mai = c(0.25,0.25,0.05,0.05),mgp = c(1.25,0.5,0))
...
# Plot bulk90
pdf(file = "./plots/UMAP_DEGs_and_all_hets_bulk90.pdf",width = 1.5625,height = 1.5625,pointsize = 7,useDingbats = F)
par(mai = c(0.25,0.25,0.05,0.05),mgp = c(1.25,0.5,0))
...
# Plot 10cRNA-seq
pdf(file = "./plots/UMAP_DEGs_and_all_hets_10c.pdf",width = 1.5625,height = 1.5625,pointsize = 7,useDingbats = F)
par(mai = c(0.25,0.25,0.05,0.05),mgp = c(1.25,0.5,0))

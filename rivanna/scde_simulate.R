...
iFemalePooled <- sample(which(opc12.info$sex == "female" & opc12.info$type == "pooled"))
iFemaleTenCell <- sample(which(opc12.info$sex == "female" & opc12.info$type == "ten-cell"))
iMalePooled <- sample(which(opc12.info$sex == "male" & opc12.info$type == "pooled"))
iMaleTenCell <- sample(which(opc12.info$sex == "male" & opc12.info$type == "ten-cell"))
...
resFemale <- runPagoda(rsem = opc12,

...
legend(x = "topright",legend = c("Control","N1P"),pch = c(1,16),pt.lwd = 0.5/0.75,bty = "n")
dev.off()

pdf(file = "./plots/pca_subtype_bulk12.pdf",width = 2.25,height = 2.25,pointsize = 7,useDingbats = F,family = "ArialMT")
par(mai = c(0.5,0.5,0,0),mgp = c(1.6,0.6,0),xpd = T)

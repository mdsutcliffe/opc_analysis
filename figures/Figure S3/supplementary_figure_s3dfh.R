...
pdf(file = "./Figure S3/figure_s3d.pdf",width = 3.125,height = 2.34375,pointsize = 7,useDingbats = F,bg = "white")
...
pdf(file = "./Figure S3/figure_s3f.pdf",width = 3.125,height = 2.34375,pointsize = 7,useDingbats = F,bg = "white")
par(mai = c(0.5,0.75,0.25,0.25),mgp = c(1.6,0.6,0))
graphics::plot(x = NULL,y = NULL,
               xlim = c(0,80),ylim = c(0.5,6.5),
...
pdf(file = "./Figure S3/figure_s3h.pdf",width = 3.125,height = 2.34375,pointsize = 7,useDingbats = F,bg = "white")
par(mai = c(0.5,0.75,0.25,0.25),mgp = c(1.6,0.6,0))
graphics::plot(x = NULL,y = NULL,
               xlim = c(0,80),ylim = c(0.5,6.5),

...
pdf(file = "./Figure 3/figure_3c.pdf",width = 3.125,height = 3.125,pointsize = 7,useDingbats = F,bg = "white")
par(mai = c(0.75,0.5,0.25,0.5),mgp = c(1.6,0.6,0),xpd = T,lwd = 0.5/0.75)
plot(x = opc12$pc$projection1[opc12$info$type == "ten-cell"],
     y = opc12$pc$projection2[opc12$info$type == "ten-cell"],
     pch = 16,
     xlim = c(-60,60),ylim = c(0,140),
     frame = F,
     xaxs = "i",yaxs = "i",
     xlab = NA,ylab = "Proliferation",main = "10cRNA-seq 12 dpi samples",font.main = 1,cex.main = 8/7,
     axes = F)
